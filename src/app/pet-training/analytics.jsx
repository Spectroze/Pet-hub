    ...
    const fetchAnalyticsData = async () => {
      try {
        ...
        const filteredPets = petCollection.documents.filter((doc) => {
          ...
          return (
            petServices.includes("Pet Training") && status.includes("Accepted") // Only include pets with "Accepted" status
          );
        });
        ...
        filteredPets.forEach((doc) => {
          ...
          if (
            petName &&
            petServices.includes("Pet Training") &&
        ...
        filteredPets.forEach((doc) => {
          ...
          if (petServices.includes("Pet Training")) {
    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <AnalyticsCard
            title="Total Pet Training Appointments"
